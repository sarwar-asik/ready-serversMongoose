      ...
      contentSecurityPolicy: {
        directives: {
          ...
          scriptSrc: [
            "'self'",
            "'unsafe-inline'",
            'https://192.168.12.31:5001',
          ],
          styleSrc: ["'self'", "'unsafe-inline'", 'https://192.168.12.31:5001'],
          connectSrc: ["'self'", 'https://192.168.12.31:5001'],
          imgSrc: ["'self'", 'https://192.168.12.31:5001', 'data:'],
          fontSrc: ["'self'"],
          objectSrc: ["'none'"],
          mediaSrc: ["'self'"],
          frameSrc: ["'self'"],
